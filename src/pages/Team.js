        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12 mb-12 md:mb-16 lg:mb-20">
          ...
          <div class="team-member">
            <div class="mb-4 md:mb-6 relative overflow-hidden group">
              <img src="/Headshots/Vivian.png" alt="Vivian Chan" class="w-full h-64 md:h-72 lg:h-80 object-cover object-top rounded-sm transition-transform duration-300 group-hover:scale-110 max-w-full" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
          ...
          <div class="team-member">
            <div class="mb-4 md:mb-6 relative overflow-hidden group">
              <img src="/Headshots/Dannick.png" alt="Dannick Young" class="w-full h-64 md:h-72 lg:h-80 object-cover object-top rounded-sm transition-transform duration-300 group-hover:scale-110 max-w-full" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
              <div class="w-full h-64 md:h-72 lg:h-80 bg-vici-white/5 rounded-sm flex items-center justify-center" style="display: none;">
                <span class="text-3xl md:text-4xl text-vici-white/20">Photo</span>
              </div>
            </div>
          ...
          <div class="team-member">
            <div class="mb-4 md:mb-6 relative overflow-hidden group">
              <img src="/Headshots/Mathias.png" alt="Mathias Choo" class="w-full h-64 md:h-72 lg:h-80 object-cover object-top rounded-sm transition-transform duration-300 group-hover:scale-110 max-w-full" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
              <div class="w-full h-64 md:h-72 lg:h-80 bg-vici-white/5 rounded-sm flex items-center justify-center" style="display: none;">
                <span class="text-3xl md:text-4xl text-vici-white/20">Photo</span>
              </div>
            </div>
